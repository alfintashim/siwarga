...
@section('title')
<title>Pengurus RT | Informasi | Tambah</title>
@endsection
...
<section class="content-header">
  <h1>
    Informasi
    <small>tambah informasi terbaru</small>
  </h1>
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-plus"></i> Tambah Informasi</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- form start -->
        <form role="form" method="POST" action="{{ URL::to('/pengurus/berita/tambah')}}" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="box-body">
            ...
            <div class="form-group">
              <label>Isi Informasi</label>
                <textarea name="isi" class="textarea" placeholder="Tulis isi beritanya disini"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"  required></textarea>
            </div>
            <div class="form-group">
              <label>Penulis</label>
              <input type="text" name="penulis" class="form-control" value="Pengurus RT" required>
            </div>
            <div class="form-group">
